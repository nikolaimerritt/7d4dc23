...
public class DatabaseInitialiser
{
    ...
    private static readonly TimeSpan RoundMovingDuration = TimeSpan.FromMinutes(20);
    private static readonly DateTime FirstRoundStart = DateTime.UtcNow + TimeSpan.FromSeconds(30);
