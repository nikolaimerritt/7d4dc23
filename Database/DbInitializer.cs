...
public static class DbInitializer
{
    ...
    public static void Initialize(AppDbContext context)
    {
        ...
        if (!context.Hints.Any())
        {
            ...
            hint = new Hint { Name = "Hint 7", Text = "The hacker does not use Arch Linux." };
            ...
            hint = new Hint { Name = "Hint 10", Text = "The hacker is from Japan." };
            context.Hints.Add(hint);
        ...
        {
            var flag = new Flag { Name = "Flag 1", Value = "coffee-razor54", };
            context.Flags.Add(flag);

            flag = new Flag { Name = "Flag 2", Value = "market-tape12", };
            context.Flags.Add(flag);

            flag = new Flag { Name = "Flag 3", Value = "fan-microwave75", };
            context.Flags.Add(flag);

            flag = new Flag { Name = "Flag 4", Value = "socket-bedroom89", };
            context.Flags.Add(flag);

            flag = new Flag { Name = "Flag 5", Value = "casket-pillow21", };
            context.Flags.Add(flag);
